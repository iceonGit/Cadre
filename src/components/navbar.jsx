      ...
      <main className=" w-full flex items-center gap-8 py-3 text-white ">
        <div className="font-semibold text-xl pl-4 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link to="/">
              <span className="text-pink-500">Cad</span>re
            </Link>
...
export const Tags = ({ item }) => {
  ...
  return (
    <>
      <div
        onClick={handleClick}
        className="px-3 cursor-pointer keen-slider__slide py-1 min-w-max hover:bg-dark-100 font-medium text-base rounded-[7px] bg-dark-200 text-white"
      >
        {item}
      </div>
    </>

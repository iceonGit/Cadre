    ...
    <>
      <div className="flex gap-4 relative items-center">
        <div className="w-[600px] border-[1px] overflow-hidden text-white font-medium font-primary border-gray-800 flex px- rounded-full bg-dark-10 ">
          ...
          <div
            onClick={handleClick}
            className="flex items-center cursor-pointer w-16 justify-center bg-dark-200"
          >
        ...
        <div
          ...
          className=" bg-dark-200 w-10 h-10 cursor-pointer flex items-center justify-center rounded-full"
        >
          <img src="/voice.svg" alt="" />
        </div>
        {showVoiceSearch && (
          <VoiceSearch setShow={setShowVoiceSearch} setSearch={setSearch} />
        )}
  ...
  return (
    <>
      <div className="w-full absolute pt-2 bg-white flex flex-col top-[51px] z-20 scroll rounded-[12px] overflow-y-scroll h-[400px]">
        {arr.map((item) => (
          <div className="flex gap-4 hover:bg-gray-200 cursor-pointer font-semibold px-5 py-2 text-dark-200">
